...
using Inventory.Responsive.Services;
...
builder.Services.AddScoped<IActivosServices, ActivosServices>();
...
builder.Services.AddScoped<IDonacionesServices, DonacionesServices>();
